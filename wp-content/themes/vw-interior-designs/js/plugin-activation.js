jQuery(document).ready(function($) {
    'use strict';
    var this_obj = vw_interior_designs_plugin_activate_plugin;
    ...
    $(document).on('click', '.vw-interior-designs-plugin-install', function(event) {
        ...
        wp.updates.installPlugin({
            ...
            success: function(data) {
                ...
                button.removeClass('button-secondary updating-message vw-interior-designs-plugin-install');
                button.addClass('button-primary vw-interior-designs-plugin-activate');
                button.trigger('click');
            },
            error: function(data) {
                jQuery('.vw-interior-designs-recommended-plugins .vw-interior-designs-activation-note').css('display','block');
    ...
    $(document).on('click', '.vw-interior-designs-plugin-activate', function(event) {
    ...
    jQuery('#lite_theme .ibtana-skip-btn').click(function(){
        ...
        jQuery('#lite_theme .vw-interior-designs-recommended-plugins').css('display','none');
    });

    jQuery('#block_pattern .ibtana-skip-btn').click(function(){
        var light_theme = jQuery(this).attr('get-start-tab-id');
        jQuery('.' + light_theme).css('display','block');
        jQuery('#block_pattern .vw-interior-designs-recommended-plugins').css('display','none');
    });
