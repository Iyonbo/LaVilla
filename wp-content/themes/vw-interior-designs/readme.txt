...
= 0.5.3 =
  ...
  -- Added slider & video button text option in customizer.
...
= 0.6.1 =
  ...
  -- Resolved error of Sticky header, slider & scroll to top show/ hide does not work in responsive media settings.
  -- Resolved error of Scroll appears on the top of the page & scroll appears first after refreshing page.

= 0.6.2 =
  -- Done slider sec button css of block pattern in tab media.
  ...
  -- Resolved error of On loading screen video section, logo & sticky header are showing.
...
VW Interior Designs WordPress Theme, Copyright 2018 VWthemes
VW Interior Designs is distributed under the terms of the GNU GPL.
...
*  Stocksnap Images, 
  ...
  Header Image, Copyright Dahl House Design
  License: CC0 1.0 Universal (CC0 1.0)
  Source: https://stocksnap.io/photo/TDNJ1H4VYN

  Post Image, Copyright Medhat Ayad
  License: CC0 1.0 Universal (CC0 1.0)
  Source: https://stocksnap.io/photo/EGXWIV409M
 
All the icons taken from genericons licensed under GPL License.
http://genericons.com/

== Theme Documentation ==
Documentation : https://www.vwthemesdemo.com/docs/free-vw-interior-designs/