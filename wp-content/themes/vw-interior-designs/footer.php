      	...
      	<div class="copyright container">
            ...
            <?php if( get_theme_mod( 'vw_interior_designs_hide_show_scroll',true) != '' || get_theme_mod( 'vw_interior_designs_resp_scroll_top_hide_show',true) != '') { ?>
                ...
                if($vw_interior_designs_theme_lay == 'Left'){ ?>
                    <a href="#" class="scrollup left"><i class="<?php echo esc_attr(get_theme_mod('vw_interior_designs_scroll_to_top_icon','fas fa-long-arrow-alt-up')); ?>"></i><span class="screen-reader-text"><?php esc_html_e( 'Scroll Up', 'vw-interior-designs' ); ?></span></a>
                <?php }else if($vw_interior_designs_theme_lay == 'Center'){ ?>
                    <a href="#" class="scrollup center"><i class="<?php echo esc_attr(get_theme_mod('vw_interior_designs_scroll_to_top_icon','fas fa-long-arrow-alt-up')); ?>"></i><span class="screen-reader-text"><?php esc_html_e( 'Scroll Up', 'vw-interior-designs' ); ?></span></a>
                <?php }else{ ?>
                    <a href="#" class="scrollup"><i class="<?php echo esc_attr(get_theme_mod('vw_interior_designs_scroll_to_top_icon','fas fa-long-arrow-alt-up')); ?>"></i><span class="screen-reader-text"><?php esc_html_e( 'Scroll Up', 'vw-interior-designs' ); ?></span></a>
                <?php }?>
            <?php }?>
      	</div>
      	<div class="clear"></div>
