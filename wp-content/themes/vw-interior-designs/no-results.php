...
<div class="title-box">
    <div class="container">
        <h2 class="entry-title"><?php esc_html_e( 'Nothing Found', 'vw-interior-designs' ); ?></h2>
    </div>
</div>
...
<?php if ( is_home() && current_user_can( 'publish_posts' ) ) : ?>
	...
	<div class="error-btn">
		<a href="<?php echo esc_url(home_url() ); ?>"><?php esc_html_e( 'Back to Home Page', 'vw-interior-designs' ); ?><span class="screen-reader-text"><?php esc_html_e( 'Back to Home Page','vw-interior-designs' );?></span></a>
	</div>
<?php endif; ?>